  ...
  render() {
    ...
    return (
      <div className="mainbar">
        ...
        <ReviewBlurb clientName="Lorem ipsum dolor" rating={5} image={image} reviewText={lorem} />
        <ReviewBlurb clientName="Lorem ipsum dolor" rating={4} image={image} reviewText={lorem} />
        <ReviewBlurb clientName="Lorem ipsum dolor" rating={3} image={image} reviewText={lorem} />
        <ReviewBlurb clientName="Lorem ipsum dolor" rating={5} image={image} reviewText={lorem} />
      </div>
    );
  }
