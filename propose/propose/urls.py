...
urlpatterns = [
    ...
    url(r'^dashboards/project/(?P<pk>[0-9]+)/$', generic.TemplateView.as_view(template_name='dashboardproject.html')),
    ...
    url(r'^settings/$', generic.TemplateView.as_view(template_name='settings.html')),
