...
urlpatterns = [
    ...
    url(r'^search/freelancer/', generic.TemplateView.as_view(template_name='freelancer_search.html')),
    url(r'^search/project/', generic.TemplateView.as_view(template_name='project_search.html')),
